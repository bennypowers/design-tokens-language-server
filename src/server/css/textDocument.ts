...
export class FullTextDocument implements TextDocument {
	 ...
	 */
	static create(uri: DocumentUri, languageId: string, version: number, content: string): TextDocument {
	 ...
	 *
	 */
	static update(document: TextDocument, changes: TextDocumentContentChangeEvent[], version: number): TextDocument {
	...
	static applyEdits(document: TextDocument, edits: TextEdit[]): string {
